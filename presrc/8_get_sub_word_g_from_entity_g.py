...
def get_word_g_by_r_edge(args):
    ...
    if args.k > 0:
        ...
        file = os.path.join(args.dp + args.dn, args.ct + 'wg_r_dict_truncated_rand_{}.txt'.format(args.k))
        random_rel_lists_file = os.path.join(args.dp + args.dn, args.ct + 'rel_rand_{}.txt'.format(args.k))
    else:
        random_rel_lists = rel_lists
        file = os.path.join(args.dp + args.dn, args.ct + 'wg_r_dict_truncated.txt')
