...
def build_word_graphs(args):
    file = os.path.join(args.dp + args.dn, args.ct + 'wg_dict_truncated.txt')
    if not check_exist(file):
        total_data, total_time = load_quadruples(args.dp + args.dn, args.ct + 'train.txt', args.ct + 'valid.txt',
                                                 args.ct + 'test.txt')
