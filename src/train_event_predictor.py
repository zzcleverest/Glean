...
while iterations < args.runs:
    ...
    if iterations == 1:
        ...
        train_dataset_loader = DistData(
            args.dp, args.dn, num_nodes, num_rels, set_name=args.ct + 'train')
        valid_dataset_loader = DistData(
            args.dp, args.dn, num_nodes, num_rels, set_name=args.ct + 'valid')
        test_dataset_loader = DistData(
            args.dp, args.dn, num_nodes, num_rels, set_name=args.ct + 'test')
        ...
        with open(args.dp + args.dn + '/' + args.ct + 'wg_dict_truncated.txt', 'rb') as f:
