...
def get_tokens(args):
    text_f = os.path.join(args.dp, args.dn, args.ct + 'text.txt')
...
if __name__ == "__main__":
    ...
    if os.path.exists(os.path.join(args.dp, args.dn, args.ct + 'text_token.txt')):
        print(args.ct + 'text_token.txt exists')
        exit()
